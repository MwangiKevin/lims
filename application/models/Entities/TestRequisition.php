...
class TestRequisition
{
     ...
     * @var string
     *
     * Column(name="req_no", type="string", length=50, nullable=false)
     */
    private $reqNo;
     ...
     * @var \DateTime
     *
     * Column(name="date_dispatched", type="date", nullable=false)
     */
     ...
     * @var \DateTime
     *
     * Column(name="date_received", type="date", nullable=false)
     */
     ...
     * @var string
     *
     * Column(name="rejection_address", type="string", length=200, nullable=false)
     */
     ...
     * @var string
     *
     * Column(name="lab_comments", type="string", length=200, nullable=false)
     */
    private $labComments;
