...
class EidPatient
{
     ...
     * @var integer
     *
     * Column(name="entry_point", type="integer", nullable=false)
     */
    private $entryPoint;
     ...
     * @var integer
     *
     * Column(name="infant_feeding_id", type="integer", nullable=false)
     */
     ...
     * @var integer
     *
     * Column(name="prophylaxis", type="integer", nullable=false)
     */
    private $prophylaxis;
