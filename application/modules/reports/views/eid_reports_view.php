			...
			<div class="widget-main">
				...
				<div id ="" class ="reports_spaced" style="">
					<table class="my-infobox infobox">
						<!-- National -->
						<form method="post" action="<?php echo base_url().'reports/reports/all_samples' ?>">
							<tr style = "">
						...
						<!-- Regional -->
						<form method="post" action="<?php echo base_url().'reports/reports_by_area/0';?>">
							<tr style="">
								<td>									
						...
						<!-- District -->
						<form method="post" action="<?php echo base_url().'reports/reports_by_area/1';?>">
							<tr>
								<td>									
									<div class="input-group my-input-group nb" style="width:100%">
										<span class="input-group-addon my-input-group-caption">
						...
						<form method="post" action="<?php echo base_url().'reports/reports_by_area/2';?>">
							<tr>
								<td>									
									<div class="input-group my-input-group nb" style="width:100%">
										<span class="input-group-addon my-input-group-caption">
				...
				<div id ="" class ="reports_spaced" style="">
					<table class="my-infobox infobox">
						<form method="post" action="<?php echo base_url().'reports/lab_reports/0' ?>">
							<tr style = "">
						...
						<form method="post" action="<?php echo base_url().'reports/lab_reports/1' ?>">
							<tr style = "">
								<td style="height:37px;">
									<div style="vertical-align:middle;float:right;padding-right:15%" >
						...
						<form method="post" action="<?php echo base_url().'reports/lab_reports/2' ?>">
							<tr style = "">
								<td style="height:37px;">
									<div style="vertical-align:middle;float:right;padding-right:15%" >
						...
						<form method="post" action="<?php echo base_url().'reports/lab_reports/3' ?>">
							<tr style = "">
								<td style="height:37px;">
									<div style="vertical-align:middle;float:right;padding-right:15%" >
						...
						<form method="post" action="<?php echo base_url().'reports/reports/lab_reports/4' ?>">
							<tr style = "">
								<td style="height:37px;">
									<div style="vertical-align:middle;float:right;padding-right:15%" >
