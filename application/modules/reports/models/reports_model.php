...
class reports_model extends MY_Model {
	...
	public function reports_by_area($area,$location,$start_date,$end_date){
		if($area == 0){//regions
			$where_clause = "WHERE `vfd`.`region_name` = '".$location."' ";
		}else if($area == 1){//districts
			$where_clause = "WHERE `vfd`.`district_name` = '".$location."' ";
		}else if($area == 2){//facilities
			$where_clause = "WHERE `vfd`.`facility_name` = '".$location."' ";
		}else{}
