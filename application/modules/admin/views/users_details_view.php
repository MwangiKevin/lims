		...
		<table style="font-size:90%" id="tests_table" class="table table-bordered table-responsive">
			...
			<tbody>
				...
				<tr id="tr_<?php echo $user["user_id"]; ?>">
                    ...
                    <td><center><a class="blue" href="jav"><i class="ace-icon fa fa-pencil bigger-130"></i></a></center></td>
                </tr>
		...
		<table style="font-size:90%" id="tests_table" class="table table-bordered table-responsive">
			...
			<tbody>
				...
				<tr id="tr_<?php echo $facility["user_id"]; ?>">
					...
					<td><center><a class="red" href=""><i class="ace-icon fa fa-trash-o bigger-130"></i></a></center></td>
                    <td><center><a class="blue" href="#edituserdetails"><i class="ace-icon fa fa-pencil bigger-130"></i></a></center></td>
                </tr>
