						...
						<tr onclick="rowclicked(<?php echo $i  ?>)">
							...
							<td>
								<div class="action-buttons">
									<a class="blue" href="<?php echo base_url()."eid/worksheet/view_zoom/".$i ?>" data-toggle:"modal">
										<i class="ace-icon fa fa-search-plus bigger-130"></i>
									</a>
		
									<a class="green" href="<?php echo base_url()."eid/worksheet/edit_zoom/".$i ?>">
										<i class="ace-icon fa fa-pencil bigger-130"></i>
									</a>
		
									<a class="red" href="<?php echo base_url()."eid/worksheet/delete_zoom/".$i ?>">
										<i class="ace-icon fa fa-trash-o bigger-130"></i>
									</a>
		
									<a class="green" href="<?php echo base_url()."eid/worksheet/print_worksheet_history/".$i ?>" id="print_sample">
